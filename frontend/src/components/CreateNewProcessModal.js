    ...
    <div className="modal-overlay viewer">
      <div className="modal-content">
        <div className="modal-header">
          <h3>Create a new business process model          </h3>
        </div>
        <p>You need to give a name for the new model and you may want to add a description at the same time.</p>
